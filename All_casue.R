...
param1 <- list(
  ...
  # "week""mean_temp" "humidity" "year" "A_H1" "A-H3" "B"  "o3" "no2" "pm10"  
)
...
for (i in df_list){
  ...
  plot_temp1 <- cbind(df[,c('idx','weekly_death')],pred_gam1*df$pop,pred_xg1) # get predicted death count
...
mcor <- cor(df[,-c(1,2,3)])
colnames(mcor) <- c("Week","Temperture","Humidity","Year","TypeA_H1","TypeA_H3","TypeB","O3","NO2","PM10")
...
vaxgb1$variable[which(vaxgb1$variable=="AH1")] <- 'TypeA-H1'
vaxgb1$variable[which(vaxgb1$variable=="B")] <- 'TypeB'
vaxgb1$variable[which(vaxgb1$variable=="o3")] <- 'O3'
vaxgb1$variable[which(vaxgb1$variable=="no2")] <- 'NO2'
vaxgb1$variable[which(vaxgb1$variable=="pm10")] <- 'PM 10'
vaxgb1$variable[which(vaxgb1$variable=="AH3")] <- 'TypeA-H3'

vagam1$variable[which(vagam1$variable=="AH1")] <- 'TypeA-H1'
vagam1$variable[which(vagam1$variable=="B")] <- 'TypeB'
vagam1$variable[which(vagam1$variable=="o3")] <- 'O3'
vagam1$variable[which(vagam1$variable=="no2")] <- 'NO2'
vagam1$variable[which(vagam1$variable=="pm10")] <- 'PM 10'
vagam1$variable[which(vagam1$variable=="AH3")] <- 'TypeA-H3'
